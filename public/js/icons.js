...
export const icons = {
  ...
  veiculo: BASE('<path d="M3 16V11l2-5h9l3 5h2a2 2 0 0 1 2 2v3"/><path d="M3 16h18"/><circle cx="7.5" cy="16.5" r="1.8"/><circle cx="17.5" cy="16.5" r="1.8"/>'),
  ...
  editar: BASE('<path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/><path d="M14.5 5.5l3 3"/>'),
